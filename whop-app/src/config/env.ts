...
const EnvSchema = z.object({
  ...
  NEXT_PUBLIC_WHOP_CLIENT_ID: z.string().nullish(),
  WHOP_CLIENT_SECRET: z.string().nullish(),
  WHOP_API_KEY: z.string().nullish(),
  WHOP_WEBHOOK_SECRET: z.string().nullish(),
  WHOP_REDIRECT_URI: z.string().nullish(),
