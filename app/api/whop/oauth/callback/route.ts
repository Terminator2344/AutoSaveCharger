...
import { exchangeOAuthCodeForToken } from '@/src/services/whop'
import { storeUserTokens } from '@/src/services/auth'
...
export async function GET(req: NextRequest) {
  ...
  const tokens = await exchangeOAuthCodeForToken({ code, redirectUri: url.origin + '/api/whop/oauth/callback' })
